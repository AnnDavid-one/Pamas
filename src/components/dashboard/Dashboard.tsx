...
export default function Dashboard() {
  ...
  return (
    <main className="flex flex-1 flex-col bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.12),_transparent_28%),linear-gradient(180deg,#1a2230_0%,#111827_100%)]">
      <section className="mx-auto w-full max-w-5xl">
        <Card className="overflow-hidden rounded-l border border-white/10 bg-[#1b2432]/95 shadow-2xl shadow-black/20">
          ...
          <div className="flex flex-col">
            {/* AI Output */}
            <div className="border-t border-white/10 bg-[#141c28] p-6 lg:border-l lg:border-t-0">
  ...
  <Textarea
    ...
    className="min-h-[20px] resize-none rounded-2xl border-0 bg-transparent px-4 py-4  text-white  placeholder:text-slate-500 shadow-none outline-none ring-0 focus:border-0 focus:outline-none focus:ring-0 focus-visible:border-0 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
  />
    ...
    <ArrowUp className="h-21 text-white" size={63} />
              ...
              <div className="mt-5 flex justify-end">
                <h2 className="text-primary">
                  {loading ? "Processing..." : "Generate AI Result"}
                </h2>
              </div>
